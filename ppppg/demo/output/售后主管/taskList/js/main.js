...
$(function () {
  ...
  $("#page4").height(pageHeight - slideHeight);
  ...
  $(".swiper-container-list2").height(pageHeight - slideHeight);
  initClick();
})
...
function initClick() {
  ...
  upDownInit(function (next, itemNode) {
    ...
    setTimeout(function () {
      for (var i = 0; i < 5; i++) {
        $(itemNode).before('<div class="item">上拉加载</div>');
      }
      next();
    }, 3000);
  });
...
function upDownInit(pullUp, pullDown) {
  ...
  var list2 = List(listCom, listWrap, listSlide, listList, listUpDesc);
  ListArray.push(list2);
  var listCom = ".swiper-container-list2";
  var listWrap = ".swiper-container-list2>.swiper-wrapper";
  var listSlide = ".swiper-container-list2 .swiper-slide";
  var listList = ".swiper-container-list2 .swiper-slide .list";
  var listUpDesc = ".swiper-container-list2 .refreshtip";
  var list2 = List(listCom, listWrap, listSlide, listList, listUpDesc);
  ListArray.push(list2);
